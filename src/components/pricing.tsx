      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
            Choose the plan that fits your business needs. Start monitoring
            Reddit conversations today.
          </p>
        </div>
          ...
          <Card className="relative bg-card border-border shadow-lg hover:shadow-xl transition-shadow duration-300">
            ...
            <CardContent className="space-y-6">
              ...
              <Button
                ...
                onClick={() => trackButtonClick("get_started_pro", "pricing")}
              >
                Get Started
              </Button>
            </CardContent>
          ...
          <Card className="bg-card border-border shadow-lg hover:shadow-xl transition-shadow duration-300">
            ...
            <CardContent className="space-y-6">
              ...
              <Button
                className="w-full bg-primary hover:bg-primary/90 text-primary-foreground font-semibold py-3"
                onClick={() =>
                  trackButtonClick("contact_us_enterprise", "pricing")
                }
              >
                Contact Us
              </Button>
