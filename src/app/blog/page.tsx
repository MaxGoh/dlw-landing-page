    ...
    <div>
      <header className="mb-12 text-center">
        ...
        <p className="text-lg md:text-xl lg:text-2xl text-muted-foreground leading-relaxed max-w-3xl mx-auto">
          Welcome to the Do Less Work Blog, we will share everything relating to
          Marketing, especially on{" "}
          <Image
            src="/reddit.svg"
            alt="Reddit logo"
            width={24}
          ...
          />{" "}
          <span className="text-[#FF4500] font-semibold">Reddit</span>. You can
          find our product and company updates here too.
        </p>
      </header>
